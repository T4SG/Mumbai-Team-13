...
echo json_encode(array("project_id"=>$row['project_id'],"name"=>$row['name'], "current_budget"=>$row['current_budget'], "budget_consumed"=>$row['budget_consumed'], "location"=>$row['country']));
