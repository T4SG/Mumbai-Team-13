<html>
   ...
   <link rel="stylesheet" href="assets/purl("images/picbackground.jpg")lugins/alertify/css/alertify.default.css" id="toggleCSS">
   ...
   "</td><td>" .$row[1].
   "</td><td>25</td> </tr><tr><td>" .$row[2] ."</td><td>" .$row[3] .
