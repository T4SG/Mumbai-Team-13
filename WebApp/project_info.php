...
AND project_activity.project_id =$project_id
...
where project_activity.proj_act_id= activity_tracking.proj_act_id and project_activity.project_id=$project_id group by project_activity.activity_id";
	$count=0;
